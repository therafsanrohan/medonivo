...
import { EPrescriptionModal } from '@/components/doctor/EPrescriptionModal';
import { PrescribedMedicine, ConsultationRecord } from '@/fixtures/doctor/doctor-workspace-fixtures';
