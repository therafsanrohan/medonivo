...
import { DoctorAuthProvider, useDoctorAuth } from '@/context/doctor/DoctorAuthContext';
...
function SidebarNav() {
  ...
  const navItems = [
    { href: '/doctor', label: 'Live Queue & Home', icon: HomeIcon },
    { href: '/doctor/careloops', label: 'Patient CareLoops', icon: StethoscopeIcon },
    { href: '/doctor/reports', label: 'Report Reviews', icon: FileTextIcon, badge: pendingReportsCount },
    { href: '/doctor/messages', label: 'Patient Messages', icon: AlertCircleIcon, badge: unreadMessagesCount },
    { href: '/doctor/availability', label: 'Chamber Schedule', icon: CalendarIcon }
  ];
