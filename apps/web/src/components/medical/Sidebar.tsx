...
const navItems: NavItem[] = [
  { href: '/medical', label: 'Overview', icon: <OverviewIcon /> },
  { href: '/medical/tenants', label: 'Hospital Tenants', icon: <TenantsIcon /> },
  { href: '/medical/carepass', label: 'CarePass Plans', icon: <CarePassIcon /> },
  { href: '/medical/billing', label: 'Billing & Revenue', icon: <BillingIcon /> },
  { href: '/medical/audit', label: 'Audit Logs', icon: <AuditIcon /> },
  { href: '/medical/health', label: 'System Health', icon: <HealthIcon /> },
];
...
export function Sidebar() {
  ...
  const isActive = (href: string) => {
    if (href === '/medical') return pathname === '/medical' || pathname === '/medical/';
