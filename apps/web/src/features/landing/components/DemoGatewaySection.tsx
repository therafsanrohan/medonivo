...
export function DemoGatewaySection() {
  const roles = [
    { name: 'Patient Demo', icon: User, color: 'bg-primary-blue', route: '/patient', isExternal: false },
    { name: 'Doctor Demo', icon: Stethoscope, color: 'bg-teal-600', route: '/doctor', isExternal: false },
    { name: 'Medical Organization Demo', icon: Building2, color: 'bg-indigo-600', route: '/medical', isExternal: false },
    { name: 'Admin Demo', icon: ShieldEllipsis, color: 'bg-gray-800', route: '/admin', isExternal: false },
  ];
