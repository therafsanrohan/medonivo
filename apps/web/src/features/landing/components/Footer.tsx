      ...
      <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-mutedText">
            <li><Link href="#careloop" className="hover:text-primary-blue">CareLoop</Link></li>
            <li><Link href="#features" className="hover:text-primary-blue">Features</Link></li>
            <li><Link href="#doctors" className="hover:text-primary-blue">For Doctors</Link></li>
            <li><Link href="#organizations" className="hover:text-primary-blue">For Organizations</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-mutedText">
            ...
            <li><Link href="#" className="hover:text-primary-blue">Careers</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-mutedText">
            <li><Link href="#" className="hover:text-primary-blue">Privacy Policy</Link></li>
            <li><Link href="#" className="hover:text-primary-blue">Terms of Service</Link></li>
          </ul>
        </div>
      </div>
